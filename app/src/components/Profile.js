            ...
            <div className="profile">
                ...
                <div className="profileInfo">
                    <div className="info">
                        ...
                        <p className="content">
                            Strasznie wczoraj zachlałem. Paliłem blanty do
                            piątej rano. Film mi się urwał jak leżałem w rurze.
                            Teraz mnie krzyż napierdala. Trochę się przespałem,
                            ale musiałem wstać rano bo mam obowiązki. Mam
                            dziecko. Niektórzy mówią, że nie można chlać jak się
                            ma dzieci, ale to nie prawda. Można, tylko trzeba
                            wstawać rano. Na tym polega odpowiedzialność.
                        </p>
                    </div>
                    <div className="info">
